            ...
            IEnumerable<Movie> RentMovie = new List<Movie>() {
                ...
                new Movie
                {
                 ...
                 FrontPage = "Images/Avenger.jpg",
                  Genre ="Action",
                  Duration="2h 29m",
                  RelaseDate= Convert.ToDateTime("04/12/18"),
                  Rating="PG-13",
                  RentPrice=70,
                  SalePrice=150
                },
                ...
                new Movie
                {
                 ...
                 Genre="Comedy",
                 Duration="1h 30m",
                 RelaseDate= Convert.ToDateTime("04/12/2001"),
                 Rating="PG-MPAA",
                 RentPrice=40,
                 SalePrice=120
                },
                   new Movie
              {
                  ...
                  Genre="Fiction",
                  Duration="2h 32m",
                  RelaseDate= Convert.ToDateTime("11/14/2001"),
                  Rating="PG-MPAA",
                  RentPrice=50,
                  SalePrice=130
                 ...
                 new Movie
              {
                  ...
                  Genre="Fiction",
                  Duration="1h 57m",
                  RelaseDate= Convert.ToDateTime("10/16/20"),
                  Rating="PG-MPAA",
                  RentPrice=45,
                  SalePrice=130
                  ...
                  new Movie
              {
                  ...
                  Genre="Comedy",
                  Duration="1h 45m",
                  RelaseDate= Convert.ToDateTime("07/28/13"),
                  Rating="PG-MPAA",
                  RentPrice=45,
                  SalePrice=130
                   ...
                   new Movie
              {
                  ...
                  Genre="Romance/Drama",
                  Duration="3h 14m",
                  RelaseDate= Convert.ToDateTime("12/19/1997"),
                  Rating="PG-MPAA",
                  RentPrice=50,
                  SalePrice=115
